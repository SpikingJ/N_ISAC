...
# The N-ISAC paper is implemented using 'snn' package in https://github.com/kclip/snn, which has not been updated for a while.
...
# It may also yield better results and could serve as a starting point for further extensions. 
